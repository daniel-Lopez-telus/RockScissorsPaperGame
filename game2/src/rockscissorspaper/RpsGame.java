...
import rockscissorspaper.players.ComputerPlayer;
import rockscissorspaper.players.HumanPlayer;
...
public class RpsGame {
    ...
    public Match createMatch(ArrayList players){
    ...
    public String getMessages(int option) {
